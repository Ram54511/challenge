...
public enum ResponseCode {
	...
	ACKNOWLEDGE(250, "returned response object"),
	ACKNOWLEDGE_OPTIONAL_RESPONSE_OBJECT(251, "returned response object is optional"),
	ACKNOWLEDGE_WITHOUT_RESPONSE_OBJECT(252, "no need of response object");
	;
