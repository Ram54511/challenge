package com.code.challenge.security.factory;
...
import com.code.challenge.constant.ChallengeConstant;
import com.code.challenge.security.login.JWTAuthenticationResponse;
...
public class JWTTokenFactory {
    ...
    public JWTTokenFactory() {
        if (tokenSecret == null) {
            tokenSecret = ChallengeConstant.JWT_SECRET;
        }
        if (expirationTime == null) {
            expirationTime = ChallengeConstant.JWT_EXPIRATION;
        }
